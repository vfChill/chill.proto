 var chillModule =angular
  .module('MyApp',['ngMaterial', 'ngMessages', 'material.svgAssetsCache','ui.mask'])
  .controller('DemoCtrl', function($scope, $mdDialog) {
    ...
    $scope.totalRepayment = function(user){
        return ($scope.parseIntBase10(user.maxTerm) * $scope.parseIntBase10(user.monthlyPayment)+$scope.parseIntBase10(user.loan));
    }
